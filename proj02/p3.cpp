...
int* printdeck(int num);//Prints out the deck at the start
...
int* printdeck(int num){//Prints out the deck
  int* deck = new int[52];    
  cout << "[";
...
void print (int* hand, int turn){//Prints out the hands
...
int* deal(int* hand, int* deck, int turn, int num){//Adds a card to the input hand
  hand[turn] = deck[num];
  return hand;
}
